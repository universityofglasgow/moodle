...
$string['courseactivity'] = 'Course activity tests';
...
$string['duplicateactivityrestrictions'] = 'Duplicate activity names linked to restriction rules';
$string['duplicateactivityrestrictions_desc'] = 'Tests if there are duplicate activity names that link to restriction rules.';
$string['duplicateactivityrestrictions_impact'] = 'Activities with duplicate names have been created - check that they point to the correct declaration. ';
$string['duplicateactivityrestrictions_success_text'] = 'Activity restrictions are configured correctly for all activities.';
...
$string['mygrades'] = 'MyGrades Specific tests';
$string['mygrades_gradebook_link_text'] = 'Gradebook setup';
$string['mygrades_enablestudentmygrades'] = 'The "Enable Student MyGrades" checkbox has been checked';
$string['mygrades_enablestudentmygrades_desc'] = 'Tests if the "Enable Student MyGrades" checkbox has been checked on the course settings page - in order for the course to be displayed within Student MyGrades.';
$string['mygrades_enablestudentmygrades_not_checked_text'] = 'The "Enable Student MyGrades" checkbox is not checked - this course will not appear on Student MyGrades. You can fix this in the {$a->coursesettingslink} page.';
$string['mygrades_enablestudentmygrades_success_text'] = 'The "Enable Student MyGrades" checkbox is checked.';
$string['mygrades_enablestudentmygrades_impact'] = '{$a->outcometext}<br />';
$string['mygrades_summativecoursecategory'] = 'A top level "Summative" category exists for the course';
$string['mygrades_summativecoursecategory_desc'] = 'Tests that a top level category named "Summative" exists. Without it MyGrades won\'t work.';
$string['mygrades_summativecoursecategory_no_category_text'] = 'The top level "Summative" category is missing or incorrectly named. You can fix this in the {$a->gradecategorylink} page.';
$string['mygrades_summativecoursecategory_success_text'] = 'The top level "Summative" category exists for this course.';
$string['mygrades_summativecoursecategory_impact'] = '{$a->outcometext}<br />';
$string['mygrades_categoryweighting'] = 'Summative category weighting';
$string['mygrades_categoryweighting_desc'] = 'Tests that the weighting for the top level "Summative" category is set to a maximum weight of 1.0';
$string['mygrades_categoryweighting_success_text'] = 'The "Summative" category weighting is correct for this course.';
$string['mygrades_categoryweighting_incorrect_text'] = 'The "Summative" category weighting is missing or incorrect. You can fix this in the {$a->gradecategorylink} page.';
$string['mygrades_categoryweighting_impact'] = '{$a->outcometext}<br />';
$string['mygrades_formativecoursecategory'] = 'A top level "Formative" category exists for the course';
$string['mygrades_formativecoursecategory_desc'] = 'Tests that a top level category named "Formative" exists. While not mandatory for MyGrades - this is for information purposes only.';
$string['mygrades_formativecoursecategory_no_category_text'] = 'The "Formative" category is missing or incorrectly named. While not necessary, you can fix this in the {$a->gradecategorylink} page.';
$string['mygrades_formativecoursecategory_success_text'] = 'The "Formative" category exists for this course.';
$string['mygrades_formativecoursecategory_impact'] = '{$a->outcometext}<br />';
$string['mygrades_orphanedgradeitems'] = 'All grade items have been allocated to a category';
$string['mygrades_orphanedgradeitems_desc'] = 'Tests that grade items have been allocated to a category.';
$string['mygrades_orphanedgradeitems_exist_text'] = 'One or more grade items have not been allocated to a category. You can fix this in the {$a->gradebooksetuplink} page.';
$string['mygrades_orphanedgradeitems_success_text'] = 'All grade items are assigned to a category for this course.';
$string['mygrades_orphanedgradeitems_impact'] = '{$a->outcometext}<br />';
