...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _vue_runtime_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @vue/runtime-core */ \"./node_modules/@vue/reactivity/dist/reactivity.esm-bundler.js\");\n/* harmony import */ var _vue_runtime_core__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @vue/runtime-core */ \"./node_modules/@vue/runtime-core/dist/runtime-core.esm-bundler.js\");\n/* harmony import */ var _components_NameFilter_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/components/NameFilter.vue */ \"./src/components/NameFilter.vue\");\n/* harmony import */ var _components_PagingBar_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/components/PagingBar.vue */ \"./src/components/PagingBar.vue\");\n/* harmony import */ var _components_ModalForm_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/components/ModalForm.vue */ \"./src/components/ModalForm.vue\");\n/* harmony import */ var _components_UserPicture_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/components/UserPicture.vue */ \"./src/components/UserPicture.vue\");\n/* harmony import */ var _components_CaptureGrades_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @/components/CaptureGrades.vue */ \"./src/components/CaptureGrades.vue\");\n/* harmony import */ var _components_HistoryButton_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @/components/HistoryButton.vue */ \"./src/components/HistoryButton.vue\");\n/* harmony import */ var _js_getstrings_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @/js/getstrings.js */ \"./src/js/getstrings.js\");\n/* harmony import */ var _kyvg_vue3_notification__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @kyvg/vue3-notification */ \"./node_modules/@kyvg/vue3-notification/dist/index.es.js\");\n\n\n\n\n\n\n\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  __name: 'CaptureTable',\n  props: {\n    itemid: Number\n  },\n\n  setup(__props, {\n    expose\n  }) {\n    expose();\n    const props = __props;\n    const PAGESIZE = 20;\n    const {\n      notify\n    } = (0,_kyvg_vue3_notification__WEBPACK_IMPORTED_MODULE_7__.useNotification)();\n    const users = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_8__.ref)([]);\n    const pagedusers = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_8__.ref)([]);\n    const strings = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_8__.ref)({});\n    const totalrows = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_8__.ref)(0);\n    const perpage = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_8__.ref)(PAGESIZE);\n    const currentpage = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_8__.ref)(1);\n    const usershidden = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_8__.ref)(false);\n    const namefilterref = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_8__.ref)(null);\n    const showimportmodal = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_8__.ref)(false);\n    let firstname = '';\n    let lastname = '';\n    let userids = [];\n    /**\n     * filter out paged users\n     */\n\n    function get_pagedusers() {\n      const first = (currentpage.value - 1) * PAGESIZE;\n      const last = first + PAGESIZE - 1;\n      pagedusers.value = [];\n\n      for (let i = first; i <= last; i++) {\n        if (users.value[i] != undefined) {\n          pagedusers.value.push(users.value[i]);\n        }\n      }\n    }\n    /**\n     * Get filtered/paged data\n     * @param int itemid\n     * @param char first\n     * @param char last\n     */\n\n\n    function get_page_data(itemid, first, last) {\n      const GU = window.GU;\n      const courseid = GU.courseid;\n      const fetchMany = GU.fetchMany;\n      fetchMany([{\n        methodname: 'local_gugrades_get_capture_page',\n        args: {\n          courseid: courseid,\n          gradeitemid: itemid,\n          pageno: 0,\n          pagelength: 0,\n          firstname: first,\n          lastname: last\n        }\n      }])[0].then(result => {\n        usershidden.value = result['hidden'];\n        users.value = JSON.parse(result['users']);\n        userids = users.value.map(u => u.id);\n        totalrows.value = users.value.length; //window.console.log(result['users']);\n\n        get_pagedusers();\n      }).catch(error => {\n        window.console.log(error);\n      });\n    }\n    /**\n     * Firstname/lastname filter selected\n     * @param {*} first \n     * @param {*} last \n     */\n\n\n    function filter_selected(first, last) {\n      if (first == 'all') {\n        first = '';\n      }\n\n      if (last == 'all') {\n        last = '';\n      }\n\n      firstname = first;\n      lastname = last; // Reset page\n\n      currentpage.value = 1;\n      get_page_data(props.itemid, first, last);\n    }\n    /**\n     * Page selected on paging bar\n     * @param int page\n     */\n\n\n    function pagechanged(page) {\n      //window.console.log(namefilterref);\n      if ('reset_filter' in namefilterref) {\n        window.console.log('GOT TO PAGE CHANGE RESET');\n        namefilterref.reset_filter();\n      }\n\n      currentpage.value = page;\n      get_pagedusers();\n    }\n    /**\n     * Import grades button clicked\n     */\n\n\n    function importgrades() {\n      window.console.log('IMPORT GRADES');\n      const GU = window.GU;\n      const courseid = GU.courseid;\n      const fetchMany = GU.fetchMany;\n      fetchMany([{\n        methodname: 'local_gugrades_import_grades_users',\n        args: {\n          courseid: courseid,\n          gradeitemid: props.itemid,\n          userlist: userids.toString()\n        }\n      }])[0].then(() => {\n        // Get the data for the table\n        get_page_data(props.itemid, firstname, lastname); // Done it\n\n        notify({\n          title: 'Import complete',\n          text: 'Data has been imported',\n          position: 'bottom left'\n        });\n      }).catch(error => {\n        window.console.log(error);\n      });\n      showimportmodal.value = false;\n    }\n    /**\n     * Show table if there's anything to show\n     */\n\n\n    const showtable = (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_9__.computed)(() => {\n      return users.value.length != 0;\n    });\n    /**\n     * Watch for displayed grade-item changing\n     */\n\n    (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_9__.watch)(() => props.itemid, itemid => {\n      get_page_data(itemid, firstname, lastname);\n    });\n    /**\n     * Load strings (mostly for table) and get initial data for table.\n     */\n\n    (0,_vue_runtime_core__WEBPACK_IMPORTED_MODULE_9__.onMounted)(() => {\n      // Get the moodle strings for this page\n      const stringslist = ['addgrade', 'awaitingcapture', 'firstnamelastname', 'idnumber', 'nothingtodisplay', 'grade', 'importgrades', 'userpicture'];\n      (0,_js_getstrings_js__WEBPACK_IMPORTED_MODULE_6__.getstrings)(stringslist).then(results => {\n        Object.keys(results).forEach(name => {\n          strings.value[name] = results[name];\n        });\n      }).catch(error => {\n        window.console.log(error);\n      }); // Get the data for the table\n\n      get_page_data(props.itemid, firstname, lastname);\n    });\n    const __returned__ = {\n      PAGESIZE,\n      props,\n      notify,\n      users,\n      pagedusers,\n      strings,\n      totalrows,\n      perpage,\n      currentpage,\n      usershidden,\n      namefilterref,\n      showimportmodal,\n      firstname,\n      lastname,\n      userids,\n      get_pagedusers,\n      get_page_data,\n      filter_selected,\n      pagechanged,\n      importgrades,\n      showtable,\n      ref: _vue_runtime_core__WEBPACK_IMPORTED_MODULE_8__.ref,\n      defineProps: _vue_runtime_core__WEBPACK_IMPORTED_MODULE_9__.defineProps,\n      computed: _vue_runtime_core__WEBPACK_IMPORTED_MODULE_9__.computed,\n      watch: _vue_runtime_core__WEBPACK_IMPORTED_MODULE_9__.watch,\n      onMounted: _vue_runtime_core__WEBPACK_IMPORTED_MODULE_9__.onMounted,\n      NameFilter: _components_NameFilter_vue__WEBPACK_IMPORTED_MODULE_0__[\"default\"],\n      PagingBar: _components_PagingBar_vue__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n      ModalForm: _components_ModalForm_vue__WEBPACK_IMPORTED_MODULE_2__[\"default\"],\n      UserPicture: _components_UserPicture_vue__WEBPACK_IMPORTED_MODULE_3__[\"default\"],\n      CaptureGrades: _components_CaptureGrades_vue__WEBPACK_IMPORTED_MODULE_4__[\"default\"],\n      HistoryButton: _components_HistoryButton_vue__WEBPACK_IMPORTED_MODULE_5__[\"default\"],\n      getstrings: _js_getstrings_js__WEBPACK_IMPORTED_MODULE_6__.getstrings,\n      useNotification: _kyvg_vue3_notification__WEBPACK_IMPORTED_MODULE_7__.useNotification\n    };\n    Object.defineProperty(__returned__, '__isScriptSetup', {\n      enumerable: false,\n      value: true\n    });\n    return __returned__;\n  }\n\n});\n\n//# sourceURL=webpack://gugrades_ui/./src/components/CaptureTable.vue?./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use%5B0%5D!./node_modules/vue-loader/dist/index.js??ruleSet%5B0%5D.use%5B0%5D");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _App_vue_vue_type_template_id_7ba5bd90__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./App.vue?vue&type=template&id=7ba5bd90 */ \"./src/App.vue?vue&type=template&id=7ba5bd90\");\n/* harmony import */ var _home_ubuntu_Projects_Moodle40_app_public_local_gugrades_ui_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ \"./node_modules/vue-loader/dist/exportHelper.js\");\n\nconst script = {}\n\n;\nconst __exports__ = /*#__PURE__*/(0,_home_ubuntu_Projects_Moodle40_app_public_local_gugrades_ui_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(script, [['render',_App_vue_vue_type_template_id_7ba5bd90__WEBPACK_IMPORTED_MODULE_0__.render],['__file',\"src/App.vue\"]])\n/* hot reload */\nif (false) {}\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (__exports__);\n\n//# sourceURL=webpack://gugrades_ui/./src/App.vue?");
