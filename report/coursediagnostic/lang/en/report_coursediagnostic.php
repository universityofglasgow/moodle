...
$string['coursefiles_success_text'] = 'Uploaded files (Microsoft, PDF, graphics, audio, video, backups etc) for the course are within the current system limit of <strong>{$a->filesizelimit}</strong>.';
...
$string['coursevideo_success_text'] = 'Uploaded video files for the course are within the current system limit of <strong>{$a->filesizelimit}</strong>';
...
$string['courseaudio_success_text'] = 'Uploaded audio files for the course are within the current system limit of <strong>{$a->filesizelimit}</strong>';
