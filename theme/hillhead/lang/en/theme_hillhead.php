...
$string['preset_desc'] = 'This lets you change the colour scheme of development and testing sites. It mostly exists to stop Alex pushing the Purge All Caches button on the live site.';                                                                                                                                                                
...
$string['hillhead_globalpinned_heading'] = 'Global Pinned Courses Heading';
$string['hillhead_globalpinned_heading_desc'] = 'This is the heading shown above the list of global pinned courses.';
$string['hillhead_globalpinned'] = 'Global Pinned Courses';
$string['hillhead_globalpinned_desc'] = 'This is a JSON array of courses to show on everybody\'s sidebar. [{"id":1234, "title":"Important Course"}]';
...
$string['hillhead_downtime_datetime'] = 'Planned System Maintenance Time';
$string['hillhead_downtime_datetime_desc'] = 'If there is planned system maintenance, put the start time in this box. This will show an alert to users that changes from blue (information) to yellow (warning) to red (urgent) as the time gets closer. You can use anything that strtotime() can understand, such as "2020-02-01 09:30:00".';
$string['hillhead_downtime_length'] = 'Expected Downtime Length';
$string['hillhead_downtime_length_desc'] = 'How long you expect the Moodle downtime to last. This is automatically added to the message displayed to the user. For example, 3 hours of downtime at 8AM will show "08:00 - 11:00"';
$string['hillhead_downtime_length_30'] = '30 Minutes';
$string['hillhead_downtime_length_60'] = '60 Minutes';
$string['hillhead_downtime_length_90'] = '90 Minutes';
$string['hillhead_downtime_length_120'] = '2 Hours';
...
$string['cachedef_fontawesomeiconmapping'] = 'Hillhead Icon Cache';