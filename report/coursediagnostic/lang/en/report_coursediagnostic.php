...
$string['mygrades_enabled'] = 'The "Enable Student MyGrades" has been checked';
$string['mygrades_enabled_desc'] = 'Tests if the "Enable Student MyGrades" checkbox has been checked on the course settings page - in order for the course to be displayed within Student MyGrades.';
