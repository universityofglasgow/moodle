...
$string['customfielddescription'] = 'Allow display of this course\'s grades on Student MyGrades. By checking this box you are verifying that the setup of this course is in line with process and guidance to ensure the correct presentation of assessments to students on their MyGrades page.';
$string['date'] = 'Date';
...
$string['importadditional'] = 'Skip already imported';
...
$string['importfillns'] = 'NS admin grade for non submission';
$string['importfillnshelp'] = 'Any users with no submission are automatically given an NS admin grade';
...
$string['importnomatch'] = 'WARNING: Grade configurations should be the same for all items you intent to import. They are not. Please check if you choose to continue.';
...
$string['noconversionmaps'] = 'No conversion maps have been defined. Click the \'Manage conversion maps\' tab to create the first one.';
...
$string['reasonforammendment'] = 'Reason for amendment';
...
$string['sharepointurl'] = '<a href="https://gla.sharepoint.com/sites/learning-innovation/SitePages/LISU-Guides-MyGrades.aspx?OR=Teams-HL&CT=1724679441249&clickparams=eyJBcHBOYW1lIjoiVGVhbXMtRGVza3RvcCIsIkFwcFZlcnNpb24iOiI0OS8yNDA3MTEyODgyNSJ9">LISU Staff MyGrades Guidance</a>';
$string['show'] = 'Show';
