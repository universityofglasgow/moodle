 ...
 * @copyright Ferenc 'Frank' Fengyel, ferenc.lengyel@glasgow.ac.uk
...
if ($ADMIN->fulltree) {
    $settings->add(
        new admin_setting_configcheckbox(
            'grade_report_uofguser_showrank',
    ...
    $settings->add(
        new admin_setting_configcheckbox(
            'grade_report_uofguser_showsource',
            get_string('showsource', 'gradereport_uofguser'),
            get_string('showsource_help', 'gradereport_uofguser'),
            1
        )
    );
    ...
    $settings->add(
        new admin_setting_configcheckbox(
            'grade_report_uofguser_showstatus',
            get_string('showstatus', 'gradereport_uofguser'),
            get_string('showstatus_help', 'gradereport_uofguser'),
            1
        )
    );
    ...
    $settings->add(
        new admin_setting_configcheckbox(
            'grade_report_uofguser_showpercentage',
    ...
    $settings->add(
        new admin_setting_configcheckbox(
            'grade_report_uofguser_showgrade',
    ...
    $settings->add(
        new admin_setting_configcheckbox(
            'grade_report_uofguser_showfeedback',
    ...
    $settings->add(
        new admin_setting_configcheckbox(
            'grade_report_uofguser_showrange',
    ...
    $settings->add(
        new admin_setting_configcheckbox(
            'grade_report_uofguser_showweight',
    ...
    $settings->add(
        new admin_setting_configcheckbox(
            'grade_report_uofguser_showaverage',
    ...
    $settings->add(
        new admin_setting_configcheckbox(
            'grade_report_uofguser_showlettergrade',
    ...
    $settings->add(
        new admin_setting_configselect(
            'grade_report_uofguser_rangedecimals',
    ...
    $settings->add(
        new admin_setting_configselect(
            'grade_report_uofguser_showhiddenitems',
    ...
    $settings->add(
        new admin_setting_configselect(
            'grade_report_uofguser_showtotalsifcontainhidden',
    ...
    $settings->add(
        new admin_setting_configcheckbox(
            'grade_report_uofguser_showcontributiontocoursetotal',
