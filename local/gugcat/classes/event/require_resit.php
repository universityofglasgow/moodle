...
class require_resit extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id {$this->userid} has {$this->other['status']} require resit for student with idnumber of {$this->other['idnumber']} in the course with the id of {$this->courseid}";
    }
