...
$string['developmentinprogress'] = 'Accepted - development/deployment in progress';
$string['enhance:view'] = 'View list of enhancement requests';
$string['filterstatus'] = 'Filter on status';
$string['functionality'] = 'Functionality';
$string['functionality_help'] = 'Is whatever requested currently available in existing systems or are there other solutions?';
$string['headline'] = 'One line headline or summary';
$string['impact'] = 'Impact';
$string['impact_help'] = 'Is the Board satisfied that the proposal will not adversely impact on other activities?';
$string['moreinformation'] = 'Waiting for more information';
$string['new'] = 'New';
$string['pending'] = 'Pending';
$string['pendingreview'] = 'Pending review';
$string['policies'] = 'Policies';
$string['policies_help'] = 'Is the Board satisfied that the request:<ul><li>will bring a desired benefit to the University?</li><li>will not adversely impact on other activities?</li><li>is aligned to and compatible with the current University policies and strategies?</li></ul>';
...
$string['waitingdevelopment'] = 'Accepted - waiting development/deployment';
