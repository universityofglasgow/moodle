...
Feature: Teacher can navigate to the previous or next user report in UofG User report.
  ...
  Background:
    ...
    And I am on the "Course" "grades > UofG User Report > View" page logged in as "teacher1"
