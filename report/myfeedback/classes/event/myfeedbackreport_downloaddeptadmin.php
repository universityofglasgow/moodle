 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class myfeedbackreport_downloaddeptadmin extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventmtutordownload', 'report_myfeedback');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' downloaded the departmental admin dashboard analytics";
    }
