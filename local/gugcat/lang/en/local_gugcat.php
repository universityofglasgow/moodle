...
$string['bulkimport'] = 'Bulk Import Sub-Category Grades';
$string['bulkimporterror'] = 'Bulk Import Error: All component grades must be using the same grade scale / points. Please check Gradebook set-up for the components in the sub-category and try again.';
