...
class tool_gudelete_confirmation_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('checkbox', 'recursive', get_string('recursive', 'tool_gudelete'));
        $mform->setDefault('recursive', 1);

        // Checkbox to bypass recycle bin.
        $mform->addElement('checkbox', 'disablerecyclebin', get_string('disablerecyclebin', 'tool_gudelete'));
