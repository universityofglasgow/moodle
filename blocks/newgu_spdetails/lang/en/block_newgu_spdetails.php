...
$string['beta_notification'] = 'Please be aware that some courses and/or assessments are not applicable for display on this page and throughout the semester assessments may appear or be updated. You can continue to view and access all your courses via the \'My courses\' page. Any questions about visibility of courses or assessments on MyGrades, please contact your course lecturer and/or administrator.';
...
$string['duesoon_accessibility_description'] = 'This is the Assessments due soon chart. It displays information about your assessments that require to be submitted in the next 24 hours, 7 days, 14 days or 1 calendar month.';
$string['duesoon_aria_label_text'] = 'Assessments Due Soon. A chart displaying assessments that are due in the next 24 hours, 7 days, 14 days or 1 month.';
$string['duesoon_tooltip_preamble'] = 'Due in the next ';
$string['emptyvalue'] = '—';
...
$string['status_text_upcoming'] = 'Upcoming';
