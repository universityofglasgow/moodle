...
/**
 * qtype_kprime question definition class.
 *
...
class qtype_kprime_question extends question_graded_automatically_with_countback {
     ...
     * @param mixed $row The row number.
     * @param mixed $col The column number
     * @return bool
     */
    ...
    /**
     * Checks wether a specific row is selected.
     * @param array $response
     * @param int $rownumber
     * @return bool
     */
    ...
    /**
     * Returns an array where keys are the cell names and the values are the weights.
     * @return array
     */
