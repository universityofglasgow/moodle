...
// Params. Theory should be to use defaults wherever possible.
$page = optional_param('page', 0, PARAM_INT);
$sortby = optional_param('sortby', 'lastname', PARAM_ALPHA);
$sorthow = optional_param('sorthow', 'ASC', PARAM_ALPHA);

$viewallstudents_sortby = optional_param('viewallstudents_sortby', 'lastname', PARAM_ALPHA);
$viewallstudents_sorthow = optional_param('viewallstudents_sorthow', 'ASC', PARAM_ALPHA);
$viewallstudents_page = optional_param('viewallstudents_page', 0, PARAM_INT);
...
if ($coursework->deadline_has_passed()) {
...
$PAGE->set_button($OUTPUT->update_module_button($course_module->id, 'coursework'));
