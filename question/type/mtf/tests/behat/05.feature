...
Feature: Step 5
  ...
  # Login as teacher1 and grade manually
    When I am on the "Quiz 1" "mod_quiz > Manual grading report" page logged in as "teacher 1"
  ...
  @javascript @qtype_mtf_scenario_22
  Scenario: Testcase 22 for Moodle ≥ 5.0
  ...
  @javascript @_switch_window @qtype_mtf_scenario_22_23
  Scenario: Testcase 22, 23 for Moodle ≥ 5.0
