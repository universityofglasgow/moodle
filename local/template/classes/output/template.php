...
class template extends \moodleform {
    ...
    /**
     * Build form for the course template
     *
     * {@inheritDoc}
    ...
    public function definition() {
        ...
        global $DB;
        $categories = get_config('local_template', 'categories');
        ...
        $mform->addElement('autocomplete', 'templatecourse', get_string('templatecourse'), $templatecourses);
        $mform->addRule('templatecourse', null, 'required', null, 'client');
