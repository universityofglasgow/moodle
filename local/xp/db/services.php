...
$functions = [
    'local_xp_get_course_group_info' => [
        'classname' => 'local_xp\external\get_course_group_info',
        'methodname' => 'execute',
    ...
    'local_xp_get_course_world_ladder' => [
        'classname' => 'local_xp\external\get_course_world_ladder',
        'methodname' => 'execute',
    ...
    'local_xp_get_course_world_group_ladder' => [
        'classname' => 'local_xp\external\get_course_world_group_ladder',
        'methodname' => 'execute',
    ...
    'local_xp_get_levels_info' => [
        'classname' => 'local_xp\external\get_levels_info',
        'methodname' => 'execute',
    ...
    'local_xp_get_recent_activity' => [
        'classname' => 'local_xp\external\get_recent_activity',
        'methodname' => 'execute',
    ...
    'local_xp_get_setup' => [
        'classname' => 'local_xp\external\get_setup',
        'methodname' => 'execute',
    ...
    'local_xp_get_user_state' => [
        'classname' => 'local_xp\external\get_user_state',
        'methodname' => 'execute',
