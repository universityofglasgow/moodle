...
$string['coursegrade'] = 'Course grade tests';
$string['mygradescompatible'] = 'Gradebook summative and formative categories';
$string['mygradescompatible_desc'] = 'Gradebook contains both summative and formative categories for courses that will use MyGrades.';
$string['mygradescompatible_impact'] = 'Your course may not display as expected in Student MyGrades. Check it contains both <strong>Summative</strong> <em>and</em> <strong>Formative</strong> categories in {$a->settingslink}.';
$string['mygradescompatible_success_text'] = 'Your course contains both summative and formative categories';
