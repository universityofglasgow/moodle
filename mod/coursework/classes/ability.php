 ...
 */
class ability extends \local_ulcc_framework\ability {
    ...
    protected function allow_new_submissions_when_deadline_has_not_passed() {
        $this->allow('new',
                     'mod_coursework\models\submission',
            function (submission $submission) {
                if (!$submission->get_coursework()->deadline_has_passed()) {
                    return true;
                }
                return false;
            });
    ...
    protected function allow_finalisation_when_has_permission_and_settings_allow() {
        $this->allow('finalise',
            ...
            function (submission $submission) {
                ...
                return $allowed_to && $not_already_finalised && $early_finalisation_allowed;
            });
    }
