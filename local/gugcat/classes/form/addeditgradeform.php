...
class addeditgradeform extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('select', 'reasons', get_string('reasonaddgrade', 'local_gugcat'), $reasons,
        ...
        if ($activity->gradeitem->gradetype == GRADE_TYPE_VALUE) {
            ...
            $mform->addRule('grade', get_string('errorinputpoints', 'local_gugcat'), 'regex',
            ...
            $mform->addElement('select', 'grade', get_string('gradeformgrade', 'local_gugcat'),
                     array_unique($grades), array('class' => 'mform-custom-select', 'size' => '15'));
