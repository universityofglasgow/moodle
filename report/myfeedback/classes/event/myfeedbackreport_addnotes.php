 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class myfeedbackreport_addnotes extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportaddnotes', 'report_myfeedback');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' added self reflective notes.";
    }
