...
class grading_report {
     ...
     */
    public function __construct(array $options, coursework $coursework) {
     ...
     * @return int
     */
    private function sort_by_firstname($a, $b) {
     ...
     * @return int
     */
    private function sort_by_lastname($a, $b) {
     ...
     * @return int
     */
    private function sort_by_groupname($a, $b) {
