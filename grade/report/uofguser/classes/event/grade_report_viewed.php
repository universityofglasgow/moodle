...
namespace gradereport_uofguser\event;

/**
 * Uofguser report viewed event class.
 *
 * @package    gradereport_uofguser
 * @since      Moodle 2.8
 * @copyright  2025 Ferenc 'Frank' Fengyel <ferenc.lengyel@glasgow.ac.uk>
...
class grade_report_viewed extends \core\event\grade_report_viewed {
    ...
    public static function get_name(): string {
        return get_string('eventgradereportviewed', 'gradereport_uofguser');
    }
