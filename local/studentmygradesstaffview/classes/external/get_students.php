 ...
 */
 ...
 namespace local_studentmygradesstaffview\external;
...
class get_students extends external_api {
    ...
    public static function execute_parameters() {
        return new external_function_parameters([
            'courseid' => new external_value(PARAM_INT, 'The selected courseid', VALUE_DEFAULT),
        ]);
    }
