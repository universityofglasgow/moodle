 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class myfeedbackreport_download extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportdownload', 'report_myfeedback');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' downloaded the excel table report for the user with id '$this->relateduserid'.";
    }
