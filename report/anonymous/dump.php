...
$url = new moodle_url('/report/anonymous/dump.php', ['id' => $id, 'assign' => $assignid]);
...
// Select form.
$form = new report_anonymous\forms\dumpselect(null, [
    'id' => $id,
    'assign' => $assignid,
...
if ($form->is_cancelled()) {
    redirect(new moodle_url('/report/anonymous/index.php', ['id' => $id]));
    ...
    $url = new moodle_url('/report/anonymous/index.php', $params);
    redirect($url);
}
