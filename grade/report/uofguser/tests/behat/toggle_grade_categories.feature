...
Feature: User can toggle the visibility of the grade categories within the UofG user grade report.
  In order to focus only on the information that I am interested in
  As a teacher
  I need to be able to easily toggle the visibility of grade categories in the UofG user grade report
  ...
  Scenario: A teacher can search for and find a user to view
    Given I am on the "Course" "grades > UofG User Report > View" page logged in as "teacher1"
