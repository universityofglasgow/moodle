...
Feature: Step 1
  ...
  Scenario: Testcase 34 for Moodle ≤ 4.5
  ...
  @javascript @qtype_mtf_1_sc_34
  Scenario: Testcase 34 for Moodle ≥ 5.0
  ...
  @javascript
  Scenario: Testcase 1,3,4 for Moodle ≤ 4.5
  ...
  @javascript
  Scenario: Testcase 1,3,4 for Moodle ≥ 5.0
  ...
  @javascript
  Scenario: Testcase 7 for Moodle ≤ 4.5
  ...
  @javascript
  Scenario: Testcase 7 for Moodle ≥ 5.0
  ...
  @javascript
  Scenario: Testcase 8 for Moodle ≤ 4.5
  ...
  @javascript
  Scenario: Testcase 8 for Moodle ≥ 5.0
  ...
  @javascript
  Scenario: Testcase 1 for Moodle ≤ 4.5
  ...
  @javascript
  Scenario: Testcase 1 for Moodle ≥ 5.0
  ...
  Scenario: Testcase 13 for Moodle ≤ 4.5
  ...
  @javascript @qtype_mtf_scenario13
  Scenario: Testcase 13 for Moodle ≥ 5.0
  ...
  Scenario: Testcase 5, 6 for Moodle ≤ 4.5
  ...
  @javascript @qtype_mtf_scenario_5_6
  Scenario: Testcase 5, 6 for Moodle ≥ 5.0
  ...
  # Move the question to another category
    ...
    And the field "searchbanks" matches value "C1 - System shared question bank"
    And the field "selectcategory" matches value "Test questions (3)"
    ...
    And I click on "AnotherCat" item in the autocomplete list
  ...
  @javascript
  Scenario: Testcase 12 for Moodle ≤ 4.5
  ...
  @javascript
  Scenario: Testcase 12 for Moodle ≥ 5.0
