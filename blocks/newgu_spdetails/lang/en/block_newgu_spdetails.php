...
$string['beta_notification'] = 'Please be aware that some courses are not applicable for display on this page. You can continue to view and access all your courses via the \'My courses\' page. Any questions about visibility of courses or assessments on MyGrades, please contact your course lecturer and/or administrator.';
