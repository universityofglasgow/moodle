...
$courseid = required_param('id', PARAM_INT); // 35901
// $courseid = 35901;
...
$url = new moodle_url('/local/template/copy.php', array('id' => $courseid));
...
$mform = new \local_template\output\template(
    $url,
...
if ($mform->is_cancelled()) {
    ...
    /*
    $copydata = (object) [
        'courseid' => 123, // Course id integer.
        'fullname' => 'Dave Test', // Fullname of the destination course.
        'shortname' => 'davetest', // Shortname of the destination course.
        'category' => 2, // Category integer ID that contains the destination course.
        'visible' => 0, // Integer to detrmine of the copied course will be visible.
        'startdate' => 0, // Integer timestamp of the start of the destination course.
        'enddate' => 0, // Integer timestamp of the end of the destination course.
        'idnumber' => '', // ID of the destination course.
        'userdata' => 0, // Integer to determine if the copied course will contain user data.
    ];
    */
    ...
    if (!empty($mdata->submitdisplay)) {
        ...
        //$progressurl = new moodle_url('/local/template/copyprogress.php', array('id' => $courseid));
