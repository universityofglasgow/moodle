...
$string['legacycodes'] = 'Codes defined in course settings (shortname and idnumber fields) and here...';
$string['nocourseinfo'] = 'No course info';
$string['nolegacycodes'] = 'There are no codes defined in the course settings';
