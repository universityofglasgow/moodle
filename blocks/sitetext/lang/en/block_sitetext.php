...
$string['content_help'] = 'HTML content to be displayed in block.';
$string['sitetext:addinstance'] = 'Add a new sitetext block';
$string['sitetext:myaddinstance'] = 'Add a new sitetext block to Dashboard';
