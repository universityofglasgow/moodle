...
$timestamp1 = (int) str_replace ('Z', '', $data['validFrom_time_t']);
$date1 = date("Y-m-d\TH:i:s\Z", $timestamp1);
$timestamp2 = (int) str_replace ('Z', '', $data['validTo_time_t']);
$date2 = date("Y-m-d\TH:i:s\Z", $timestamp2);
