...
$string['autherror'] = 'An error occurred processing UofG automatic enrolment - additional information has been logged. {$a}';
...
$string['newuserauth'] = 'New user auth type';
$string['newuserauth_help'] = 'The auth type given to new users when created by auto enrolment';
...
$string['programtable'] = 'Student program table';
$string['programtable_desc'] = 'Table containing student program data';
...
$string['settingsnewuser'] = 'New users';
$string['scheduledname'] = 'Synchronise guenrolments';
$string['schoolsjson'] = 'School names JSON';
$string['schoolsjson_desc'] = 'School codes vs names';
