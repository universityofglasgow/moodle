 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class myfeedbackreport_addfeedback extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportaddfeedback', 'report_myfeedback');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' added Turnitin feedback for the user with id '$this->relateduserid'.";
    }
