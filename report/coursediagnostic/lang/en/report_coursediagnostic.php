...
$string['enddate_notset_impact'] = '<strong>This course doesn\'t have an end date</strong>. Automatic enrolments won\'t work unless you add one. This is to protect old courses from accidental changes. You can change this on {$a->settingslink}.';
...
$string['visibility_impact'] = '<strong>This course is currently hidden</strong>. You can see it, but students can\'t.<br />You can change this on {$a->settingslink}.';
...
$string['selfenrolmentkey_not_enabled_text'] = '<strong>There are no Self enrolment methods currently enabled</strong>. You can change this on the {$a->enrolmentmethodslink} page.';
$string['selfenrolmentkey_success_text'] = 'Self Enrolment methods requiring a key have been configured correctly.';
...
$string['report_summary'] = '<p>This report shows the results of the tests that have been run against this course.<br />You can use the results of these tests to ensure that your course is performing at its optimal best for end users.</p><div class="w-25 p-2 alert alert-dark" style="display:inline-block"><strong>N/A</strong></div><div style="display:inline-block">&nbsp;Indicates tests that haven\'t been enabled and can safely be ignored.</div><p><div class="w-25 p-2 alert alert-success" style="display:inline-block"><strong>OK</strong></div><div style="display:inline-block">&nbsp;Indicates tests that have successfully passed.</div></p><p><div class="w-25 p-2 alert alert-danger" style="display:inline-block"><strong>CHECK</strong></div><div style="display:inline-block">&nbsp;Indicates settings that require further investigation.</div></p>';
$string['passtext'] = 'OK';
