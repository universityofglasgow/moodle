    ...
    if (isset($filecontents)) {
        ...
        foreach ($jsondata as $tmpplugindata) {
            ...
            foreach ($plugindata as $sourceplugin) {
                ...
                $displayname = (property_exists($sourceplugin, 'displayname') ? $sourceplugin->displayname : $sourceplugin->pluginname);
                $plugindetails = array('displayname' => $displayname, 'pluginname' => $sourceplugin->pluginname,
                ...
                $versionrequires = (property_exists($sourceplugin, 'versionrequires') ? $sourceplugin->versionrequires : $sourceplugin->version);
                if ($versionrequires <= $cfgversion) {
