...
class enlargement_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addRule('continuing', null, 'required', null, 'client');
        $mform->setType('continuing', PARAM_TEXT);

        $mform->addElement('text', 'terminating', "'Terminating' WI", $att);
        $mform->addRule('terminating', null, 'required', null, 'client');
        $mform->setType('terminating', PARAM_TEXT);
        ...
        $mform->addRule('wia', null, 'required', null, 'client');
        $mform->setType('wia', PARAM_TEXT);

        $mform->addElement('static', 'mcs', '',
            '<strong>Please ensure that the MCS is up to date with the transfer of members from
            the terminating WI to the new enlarged WI</strong>');
