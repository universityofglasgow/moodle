...
final class question_test extends \advanced_testcase {
    ...
    public function test_grade_response_subpoints(): void {
        ...
        $this->assertEquals(
            "1.0",
            $question->grade_response(['option0' => '1', 'option1' => '2'])[0]
        );
        $this->assertEquals(
            "0.5",
            $question->grade_response(['option0' => '1', 'option1' => '1'])[0]
        );
        $this->assertEquals(
            "0.5",
            $question->grade_response(['option0' => '1'])[0]
        );
        $this->assertEquals(
            "0.0",
            $question->grade_response(['option0' => '2', 'option1' => '1'])[0]
        );
    }
